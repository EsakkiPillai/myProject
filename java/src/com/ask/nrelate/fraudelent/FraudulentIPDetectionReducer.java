 ...
 * Time: 12:02 PM
 */
public class FraudulentIPDetectionReducer extends Reducer<FraudulentIPDetectionKey, Text, Text, Text> {
    ...
    @Override
    protected void reduce(FraudulentIPDetectionKey key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
    ...
    public FraudulentIPDetectionReducer() {
        super();
    }
}
...
class ReducerOutput{
    ...
    ReducerOutput(String key, int eventCount, double meanFreq, int timeSlot) {
        this.key = key;
