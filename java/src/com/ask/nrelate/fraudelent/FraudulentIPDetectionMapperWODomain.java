 ...
 * Time: 12:01 PM
 */
public class FraudulentIPDetectionMapperWODomain extends Mapper<LongWritable, Text, FraudulentIPDetectionKeyWODomain, Text> {
    ...
    public FraudulentIPDetectionMapperWODomain() {
        super();
    }
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        Text mapperOutput;
        FraudulentIPDetectionKeyWODomain mapperKey = new FraudulentIPDetectionKeyWODomain();
        int timeSlot = 1;
