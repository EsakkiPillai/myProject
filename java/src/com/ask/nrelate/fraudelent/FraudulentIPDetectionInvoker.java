 ...
 * Time: 3:16 PM
 */
public class FraudulentIPDetectionInvoker extends Configured implements Tool {
    @Override
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(FraudulentIPDetectionInvoker.class);
        job.setMapperClass(FraudulentIPDetectionMapper.class);
        job.setReducerClass(FraudulentIPDetectionReducer.class);
        //job.setPartitionerClass(FraudulentIPDetectionPartitioner.class);
        
        job.setOutputKeyClass(FraudulentIPDetectionKey.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("/ask/home/nrelate/hdfs/pixel/mr/normalizer_fraudulent/" + args[1] + "/out"));
    ...
    public static void main(String[] args) throws Exception{
        int exitCode = ToolRunner.run(new FraudulentIPDetectionInvoker(), args);
