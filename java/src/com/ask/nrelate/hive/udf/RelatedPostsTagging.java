 ...
 */
public class RelatedPostsTagging extends UDF {
    ...
    public static void main(String[] args){
        RelatedPostsTagging RelatedPostsTagging = new RelatedPostsTagging();
        System.out.println(RelatedPostsTagging.evaluate("2323", "US", "cbssports.com",""));
    }
}
