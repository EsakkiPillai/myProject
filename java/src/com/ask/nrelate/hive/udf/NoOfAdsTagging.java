 ...
 */
public class NoOfAdsTagging extends UDF {
    ...
    public static void main(String[] args){
        NoOfAdsTagging NoOfAdsTagging = new NoOfAdsTagging();
        System.out.println(NoOfAdsTagging.evaluate("2013-10-01", "US", "cbssports.com",""));
    }
}
