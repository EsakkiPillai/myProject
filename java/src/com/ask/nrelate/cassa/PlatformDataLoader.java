 ...
 */
public class PlatformDataLoader {
    static String KEYSPACE = "nrelate";
    static String tableName;
    static Session session;
    private Logger logger = Logger.getLogger(PlatformDataLoader.class.getName()) ;
    ...
    public void insert(String filename) {
        PreparedStatement ps = session.prepare("INSERT INTO "+tableName+" (domain,pixeldate,platform,impressions,paidimpressions,ads,internals,externals,gross_revenue,net_revenue,gross_rpm,net_rpm,ad_ctr,internal_ctr) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parse(cassandraProperties,line, lineNumber++)) {
                    try{
                        ...
                        statement = ps.bind(cassandraProperties.getDomain(), cassandraProperties.getPixeldate(), cassandraProperties.getPlatform(),cassandraProperties.getImpressions(), cassandraProperties.getPaidimpressions(),cassandraProperties.getAds(), cassandraProperties.getInternals(), cassandraProperties.getExternals(),cassandraProperties.getGrossRevenue(),
    ...
    public static void main(String args[]) {
        ...
        PlatformDataLoader widgetDataLoader = new PlatformDataLoader();
